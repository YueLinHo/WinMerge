/** 
 * @file  ProjectFile_test_LeftAndRight.cpp
 *
...
namespace
{
	...
	class ProjectFileLeftAndRightTest : public testing::Test
	{
	protected:
		// You can remove any or all of the following functions if its body
		// is	empty.

		ProjectFileLeftAndRightTest()
		{
	 ...
	 */
	TEST_F(ProjectFileLeftAndRightTest, Load)
	{
		String sError;
	 ...
	 */
	TEST_F(ProjectFileLeftAndRightTest, GetLeftPath)
	{
		// Has left path
	 ...
	 */
	TEST_F(ProjectFileLeftAndRightTest, GetRightPath)
	{
		// Has have right path
	 ...
	 */
	TEST_F(ProjectFileLeftAndRightTest, GetSubfolders)
	{
	 ...
	 */
	TEST_F(ProjectFileLeftAndRightTest, GetFilter)
	{
